...
#include <QFrame>
#include <functional>
#include "map/qmlcoordinateproxy.h"
#include "devices/gnss/gnsshandler.h"
#include "devices/ams/amshandler.h"
#include "devices/bins/binshandler.h"
#include "core/model/InitialParameters.h"
#include "map/FormMapView.h"
#include "ui/pages/sensorsettings.h"
#include "data/surfacemeteosaver.h"
#include "ui/pages/functionalcontroldialog.h"
#include "ui/pages/workregulationhubpage.h"
#include "ui/pages/inspectionpage.h"
#include "ui/pages/anglecheckpage.h"
#include "ui/widgets/ClickableFrame.h"
#include "devices/autoconnector.h"
#include "map/LocalTileServer.h"
#include "core/windprofile/windprofilecalculator.h"
#include "ui/pages/GroundMeteoParams.h"   // для типа GroundMeteoParams::SurfaceState в слоте
