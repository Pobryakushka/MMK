...
int main(int argc, char *argv[])
{
    ...
    // визуально это выглядело как "чужой", неконсистентный интерфейс с
    // элементами не по дизайну. Фиксируем стиль, чтобы вид программы не
    // зависел от темы конкретного рабочего окружения.
